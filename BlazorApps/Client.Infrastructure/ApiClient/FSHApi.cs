...
namespace Client.Infrastructure.ApiClient
{
    ...
    public partial interface IRolesClient : IApiService
    {
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<DepartmentRoleDto>> GetDepartmentRoleListAsync(string id);
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<DepartmentRoleDto>> GetDepartmentRoleListAsync(string id, System.Threading.CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<string> CreateDepartmentRoleAsync(string id, List<CreateDepartmentRole> request, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class RolesClient : IRolesClient
    {
        ...
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<DepartmentRoleDto>>
            GetDepartmentRoleListAsync(string id)
        {
            return GetDepartmentRoleListAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<DepartmentRoleDto>> GetDepartmentRoleListAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("api/roles/departmentroleslist/{id}");
            urlBuilder_.Replace("{id}", System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<DepartmentRoleDto>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        public virtual System.Threading.Tasks.Task<string> CreateDepartmentRoleAsync(string id, List<CreateDepartmentRole> request)
        {
            return CreateDepartmentRoleAsync(id, request, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<string> CreateDepartmentRoleAsync(string id, List<CreateDepartmentRole> request, System.Threading.CancellationToken cancellationToken)
        {
            if (request == null)
                throw new System.ArgumentNullException("request");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("api/roles/{id}/departmentrole");
            urlBuilder_.Replace("{id}", System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial interface IUsersClient : IApiService
    {
        ...
        System.Threading.Tasks.Task<string> ChangeDepartmentAsync(DepartmentChange request, string userId, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class UsersClient : IUsersClient
    {
        ...
        public virtual System.Threading.Tasks.Task<string> ChangeDepartmentAsync(DepartmentChange request, string id)
        {
            return ChangeDepartmentAsync(request, id, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<string> ChangeDepartmentAsync(DepartmentChange request, string id, System.Threading.CancellationToken cancellationToken)
        {
            if (request == null)
                throw new System.ArgumentNullException("request");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("api/users/{id}/department");
            urlBuilder_.Replace("{id}", System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class CreateUserRequest
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public System.Guid DepartmentId { get; set; } = default!;
